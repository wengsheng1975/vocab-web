const styles = {
  error: {
    container: 'bg-red-50/90 border-red-200 text-red-700',
    icon: (
  ...
  success: {
    container: 'bg-emerald-50/90 border-emerald-200 text-emerald-700',
    icon: (
  ...
  warning: {
    container: 'bg-amber-50/90 border-amber-200 text-amber-700',
    icon: (
  ...
  info: {
    container: 'bg-sky-50/90 border-sky-200 text-sky-700',
    icon: (
...
export default function Alert({ type = 'error', children, onClose, className = '' }) {
  ...
  return (
    <div className={`flex items-start gap-3 p-3.5 rounded-2xl border text-sm animate-slide-down shadow-[0_6px_16px_rgba(23,34,32,0.04)] ${style.container} ${className}`}>
